...
class EmployeeDetails extends JFrame implements ActionListener, ItemListener, DocumentListener, WindowListener {
    ...
    private void firstRecord() {
        if (isSomeoneToDisplay()) {
            ...
            application.closeFile(application.input);
    ...
    public void search() {
        ...
        if(searchByIdField.getText().trim().isEmpty()) {
            if (isSomeoneToDisplay()) {
                firstRecord();
    ...
    public void addRecord(Employee newEmployee) {
        ...
        application.closeFile(application.output);
    }
    ...
    public void error(Component field){
